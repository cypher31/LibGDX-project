...
public class worldRenderer implements InputProcessor {
	...
	private static final float UNIT_SCALE = 1 / 70f;
	...
	public worldRenderer() {
		...
		level = new tiledTest("Level1-1.tmx");
		player = new Player();
		...
		player.setPosition(new Vector2(2, 8));
		player.setWidth(UNIT_SCALE * playerIdleRight.getRegionWidth() / 2);
		player.setHeight(UNIT_SCALE * playerIdleRight.getRegionHeight() / 2);
